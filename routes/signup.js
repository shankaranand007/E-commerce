           ...
           var arr = Object.keys(reqObj);
              ...
              if(arr.length == prekey.length)
            {
             req.getConnection(function(err,conn){
              ...
              var sql = "SELECT * FROM signup WHERE (email='" +reqObj.phone+ "' AND password='" +reqObj.password +"')AND verify_status=1" ;
    ...
    try{
         ...
         try {
             ...
             req.getConnection(function(err,conn){
              ...
              var sql = "SELECT * FROM signup WHERE verify_status=1 ORDER BY user_id" ;
